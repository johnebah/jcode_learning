        ...
        <div class="container-fluid">
                    ...
                    <section id="payment">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <h1 style="text-align: center; font-family: cursive;">Pay your package amount to this account</h1>
                                <div class="details">
                                    <table>
                                        <tr>
                                            <td>ACCOUNT NUMBER</td><td>0464568446</td>
                                        </tr>
                                        <tr>
                                            <td>ACCOUNT NAME</td><td>EBAH JOHN ECHI</td>
                                        </tr>
                                        <tr>
                                            <td>BANK NAME</td><td>GT BANK</td>
                                        </tr>
                                    </table>
                                   <h2 style="text-align: center; font-family: fantasy;">Note:<br> After payment, Screenshot evidence of payment to this whatsapp number +234 708 651 7956</h2> 
                                </div>
                            </div>
                            <div class="col-md-4">
